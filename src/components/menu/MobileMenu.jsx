    ...
    <M.MenuContainer>
      ...
      <M.MenuList>
        ...
        <M.InnerContainer $isOpenAccordion={openAccordion === 'business'}>
          <M.MenuTitle onClick={() => handleAccordionClick('business')} $isOpenAccordion={openAccordion === 'business'}>
        ...
        <M.InnerContainer $isOpenAccordion={openAccordion === 'activity'}>
          <M.MenuTitle onClick={() => handleAccordionClick('activity')} $isOpenAccordion={openAccordion === 'activity'}>
